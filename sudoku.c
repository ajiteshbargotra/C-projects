...
int main() 
{
    ...
    int i,j,n,s; //declaring variables
int k,l; //declaring variables
    
    int value[9][9]; //declaring matrix

    int total_row[9]; //declaring array for row
    int total_col[9]; //declaring array for column
